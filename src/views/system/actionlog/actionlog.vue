<template>
  <div class="app-container calendar-list-container" style="background-color: #f6f7fa;height: 100%">
      ...
      <div class="filter-container">
        <el-col :span="24">
          <el-row :gutter="60">
            <el-col :span="6">
              <el-form>
                <el-form-item label-width="75px" label="进件编号:" class="postInfo-container-item" style="width: 100%;">
                  <el-input prefix-icon="el-icon-search" v-model="search_merchant_no" placeholder="进件编号">
                  </el-input>
                </el-form-item>
              </el-form>
            </el-col>
            <el-col :span="6">
              <el-form>
                <el-form-item label-width="90px" label="身份证号码:" class="postInfo-container-item" style="width: 100%;">
                  <el-input prefix-icon="el-icon-search" v-model="search_customer_certificate_number" placeholder="身份证号码">
                  </el-input>
                </el-form-item>
              </el-form>
            </el-col>
    ...
    <el-table :key='tableKey' :data="list" v-loading="listLoading" element-loading-text="给我一点时间" border fit highlight-current-row
      ...
      <el-table-column align="center" label="身份证号码" min-width="120px">
        <template slot-scope="scope">
          <span>{{scope.row.customer_certificate_number}}</span><!--<span>{{scope.row.timestamp | parseTime('{y}-{m}-{d} {h}:{i}')}}</span>-->
        </template>
      </el-table-column>
...
export default {
  ...
  data() {
    ...
    return {
      ...
      search_page: 1,
      search_size: 10,
      search_customer_certificate_number: '',
      token: getAdminToken(),
      tableKey: 0,
      list: null,
      total: null,
  ...
  computed: {
    ...
    // 接口传入参数
  	searchdata(){
        ...
        merchant_no: this.search_merchant_no,
        customer_certificate_number: this.search_customer_certificate_number,
