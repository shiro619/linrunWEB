<template>
  <div class="createPost-container createPost-container-one">
  	<el-tabs v-model="search_type" style="background-color: #ffffff;padding-left: 50px;">
	    <el-tab-pane label="财务打款" name="1"></el-tab-pane>
    ...
    <el-form class="form-container" :model="customerData" :rules="rules" ref="customerData" v-if="search_type == '1'">
      ...
      <el-row :gutter="divgutter" style="margin-top: 10px;">
	      <div class="postInfo-container postInfo-container-one" style="padding: 20px 40px 20px 338px; margin-bottom: 0px;">
	      	<el-row :gutter="divgutter">
			     	<el-col :span="10">
            ...
            <el-col :span="10">
		            <el-form-item :label-width="labelwidth" label="返车行金额" class="postInfo-container-item" style="width: 100%;">
		            	<span>
		            		{{customerData.return_car_principal}}元
		            	</span>
		            </el-form-item>
		        </el-col>
            ...
            <el-col :span="10">
		            <el-form-item :label-width="labelwidth" label="账号" class="postInfo-container-item" style="width: 100%;">
            ...
            <el-col :span="10">
		            <el-form-item :label-width="labelwidth" label="开户行" class="postInfo-container-item" style="width: 100%;">
          ...
          <el-col :span="10">
		        <el-form-item :label-width="labelwidth" label="打款户名" class="postInfo-container-item" style="width: 100%;">
             ...
             <el-col :span="10">
		            <el-form-item :label-width="labelwidth" label="合计打款" class="postInfo-container-item" style="width: 100%;">
		            	<span>
		            		{{customerData.remittance_total_money}}元
		            	</span>
		            </el-form-item>
		        </el-col>
            ...
            <el-col :span="10">
             ...
             <el-col :span="10">
		            <el-form-item :label-width="labelwidth" label="车行全称" class="postInfo-container-item" style="width: 100%;">
          ...
          <el-col :span="10">
            <el-form-item :label-width="labelwidth" label="业务发生地" class="postInfo-container-item" style="width: 100%;">
            ...
            <el-col :span="10">
            <el-form-item :label-width="labelwidth" label="打款日期" class="postInfo-container-item" style="width: 100%;">
            ...
            <el-col :span="10">
		            <el-form-item :label-width="labelwidth" label="打给车行" class="postInfo-container-item" style="width: 100%;">
		            		<span>
		            			{{customerData.finance_driving}}元
		            		</span>
		            </el-form-item>
		        </el-col>

        <el-col :span="20">
            <el-form-item :label-width="labelwidth" label="申请备注" class="postInfo-container-item" style="width: 100%;">
            	<span v-text="customerData.finance_apply_description"></span>
             <!--<el-input type="textarea" v-model="customerData.finance_apply_description" disabled="disabled">
  		 			</el-input>-->
            </el-form-item>
        </el-col>
      </el-row>
			</div>      
      <el-row style="padding: 20px 40px 20px 338px; background: #fff;">	
      	 <el-col :span="8">
      	  <el-form-item :label-width="labelwidth" label="已打款额" class="postInfo-container-item" style="width: 100%;" prop="remittance_prize">
             <el-input  v-model="customerData.remittance_prize" placeholder="请输入已打款额">
      	 ...
      	 <el-col :span="8">
      	  <el-form-item :label-width="labelwidth" label="已打款日期" class="postInfo-container-item" style="width: 100%;" prop="remittance_time">
           		 <el-col :span="24" style="padding-left:0px;padding-right:0px;">
             		<el-date-picker v-model="customerData.remittance_time" type="date" placeholder="选择日期" style="width:100%;">               	
								</el-date-picker>
  		 				</el-col>
            </el-form-item>
      	 </el-col>
      	 ...
      	 <el-col :span="10">
            <el-form-item :label-width="labelwidth" label="打款备注" class="postInfo-container-item" style="width: 100%;">
             <el-input type="textarea" v-model="customerData.finance_description" placeholder="( 选填 )">
  		 			</el-input>
            </el-form-item>
        </el-col>
            ...
            <el-button type="primary" style=" width: 120px; height: 40px; float:right; margin-right: 33.5%;" @click="submitData('customerData')">确定</el-button>
  ...
  data() {
    ...
    return {
    	...
    	customerData:{
    		...
    		remittance_prize:'',//打款金额
    		remittance_time:'',//打款时间
    		finance_description:'',//打款备注
    		credit_city:'',//业务团队
    	},
    	//请求数据
    	requestData:{
      ...
      rules: {
        ...
        remittance_prize: [{ validator: checkMoney, trigger: 'blur' }],
        remittance_time: [{type: 'date',message: '请选择日期', trigger: 'change'}]
      }
    }
  },
  filters: {
  ...
  computed: {
  	pagedata(){//提交事件所传得信息
  		return {
  			...
  			work_id: this.$route.query.id,
  			item_instance_id: this.$route.query.item_instance_id,
	  		remittance_prize: this.customerData.remittance_prize,
	  		remittance_time: Date.parse(this.customerData.remittance_time)/1000,
	  		finance_description: this.customerData.finance_description,
  		}
  	},
    contentShortLength() {
...
//          this.customerData.finance_name = res.result.finance_name;//年龄
//          this.customerData.finance_account = res.result.finance_account;//年龄 
//          this.customerData.finance_deposit_bank = res.result.finance_deposit_bank;//年龄
//          this.customerData.car_name = res.result.car_name;//年龄
//          this.customerData.business_place = res.result.business_place;//年龄
//          this.customerData.finance_date = res.result.finance_date;//年龄
//          this.customerData.finance_apply_description = res.result.finance_apply_description;//年龄
    ...
    //请求右侧审核历程数据
  	...
  	submitData(formName){
  		...
  		var arg = {
  			...
  			success: res =>{
  				if(res.error_no == 200){
  					this.$alert('成功提交', '财务打款', {
			          confirmButtonText: '确定',
			          beforeClose: (action,instance, done)=> {
			           if(action == 'confirm'){
			           		done();
			           		this.$router.push({ path: '/work/finance' });
  		...
  		this.$confirm('是否确定提交', '提示', {
				...
				this.$refs['customerData'].validate((valid) => {
					if(valid){
						if(Number(this.customerData.remittance_prize) !=Number(this.customerData.remittance_total_money)){
							this.$alert('已打款额不等于合计打款金额，是否继续提交', '财务打款', {
				          confirmButtonText: '确定',
				          beforeClose: (action,instance, done)=> {
				           if(action == 'confirm'){
				           		done();
				           		detailApi.finance(arg);  
				           }else if(action == 'cancel'){
				           		done();
				           }
			          	}
